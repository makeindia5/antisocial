...
const messageSchema = new mongoose.Schema({
    ...
    type: { type: String, enum: ['text', 'image', 'video', 'document', 'video_link', 'location', 'social_text', 'social_image', 'social_video', 'social_document', 'social_location', 'call'], default: 'text' },
